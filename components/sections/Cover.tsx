  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ✅ Gradient mulai dari 68% — biar kaligrafi di foto ga ketutupan */}
        <div
          style={{
            position: 'absolute',
            inset: 0,
        ...
        {/* Login-style card — pinned to bottom */}
        <motion.div
          ...
          style={{
            ...
            left: 0,
            right: 0,
            // ✅ Padding atas dikecilkan — card lebih compact, tidak naik ke zona kaligrafi
